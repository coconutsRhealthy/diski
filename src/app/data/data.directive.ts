...
export class DataDirective {
  ...
  static dataArray = [
    ...
    "temu, apu12458, €100, wgk, 09-22",
    "leolive, diski10, 10, wgk, 09-22",
    "desenio, XCENT, 4f2+10, kleinpepertje, 09-22",
    "otrium (iig 22sep), 25EXTRA, 25, otrium, 09-22",
    "nakdfashion, hesseling, 20, lolahesseling_tiktok, 09-22",
    "bylashbabe, STARLASH, 10, wgk, 09-22",
    "idealofsweden, BBSTEEF, 3f2+15, wgk, 09-22",
    "pinkgellac, LISAABLISS, 10, lisaheurman_tiktok, 09-22",
    "doonails, KLEINPEPERTJE, 20, kleinpepertje, 09-22",
    "vitakruid, DANSJE, 10, wgk, 09-22",
    ...
    "sapph, wiegeeftkorting20, 20, wgk, 09-22",
    ...
    "rosental-organics.nl, KORTINGNL, 25, wgk, 09-22",
    ...
    "hellofresh.nl, HFkleinpepertje110, €110, kleinpepertje, 09-22",
    ...
    "vitakruid, VENUS, 10, wgk, 09-20",
    "idealofsweden, BBHEM, 3f2+15, wgk, 09-20",
    ...
    "pinkgellac, HEAVENBLISS, 10, heavfun_tiktok, 09-20",
    ...
    "pinkgellac, AMBERBLISS, 10, nagels.a, 09-18",
    ...
    "stronger, ESMERALDA20, 20, esmeraldaattema, 09-16",
    ...
    "yfood (> €50), NOELL-INSTA, 10, noellvandreven, 08-29",
    ...
    "hunkemoller, honey-df234t4fvq3y4, 12, honey, 08-25",
    ...
    "lookfantastic, STUDENTBEANSNL, 13, rabatta, 08-23",
    ...
    "meetmethere, NORWAY15, 15, rabatta, 08-19",
