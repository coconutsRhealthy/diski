...
export class DataDirective {
  ...
  static dataArray = [
    ...
    "zonnebrillen.com, ROSA, 20, rosasofiakolen, 06-10",
    "loavies, SUMMER-GIOVANNI, 20, giovannihuls, 06-10",
    "aliexpress, JUNE9OT, €8, aliexpress, 06-10",
    "loavies, BARBARAVACAY, 20, jadorebar, 06-10",
    "bylashbabe, STARLASH, 10, wgk, 06-10",
    "bodyandfit.com, FOODIES10, 10, foodtrackerz, 06-10",
    ...
    "superdry, HANNAH10, 10, hannah.arguelles, 06-10",
    ...
    "adidas.nl, MAF-6NVF-MZLS-RVLV-DF7WN, 10, adidas.nl, 06-08",
    "geurwolkje, NANOEK10, 10, gewoonnanoek, 06-08",
