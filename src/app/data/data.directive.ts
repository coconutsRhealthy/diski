...
export class DataDirective {
  ...
  static dataArray = [
    ...
    "zonnebrillencom, DAELORIAN, 20, daelostylo, 05-26",
    "loavies, VACAY-FLEUR20, 20, fleurdijkstra_, 05-26",
    "bylashbabe, STARLASH, 10, wgk, 05-26",
    ...
    "hellofreshnl, HELLO85KIM, €85, kimkotter, 05-26",
    ...
    "meetmethere.nl, GLAMOUR, 20, janedoe, 05-24",
    ...
    "hellofreshnl, HELLODEMIAPP, €85, demideboer, 05-22",
