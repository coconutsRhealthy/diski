...
export class ArchiveDataDirective {
  ...
  static dataArrayArchive = [
    ...
    "aimnsportswear, STEP25, 25, rabattkode.norge, 09-16",
    ...
    "shein, 24q3laurenfit, 15, laurenhannahjadex, 08-15",
    "corendon.nl, MONIQUE100, €100, moniquesmit_insta, 08-15",
    "nakdfashion, veroniquev, 20, veroniquevalkenburg, 08-15",
    "gymshark, AIMEE, 10, aimee_cringle, 08-15",
    "desenio, XARCA, 30+10, kleinpepertje, 08-15",
    "pinkgellac, GUUSJE10, 10, guusje.willemse_tiktok, 08-15",
    "bodyandfit.com, BBJASON, 10, jasonprins_, 08-15",
    "decathlon (fitness), IRIS15, 15, irisenthoven, 08-15",
    "gutsgusto, LEONIETERVELD15, 15, lterveld, 08-15",
    "otrium, SORRYPM20, 20, honey, 08-15",
    "lyko, 15BA, 15, rabatt.inspo, 08-15",
    "esn, SHOLDEN, 20, sarahholden_fit, 08-15",
    "flaatch.nl, MISHA20, €20, privemishx_tiktok, 08-15",
    "nakdfashion, deler, 20, mdeler, 08-15",
    "myproteinnl, ilseAFF, 35, xilsevisser_tiktok, 08-15",
    "nakdfashion, Allaboutmaerry, 20, allaboutmaerry, 08-15",
    "mbnutrition.com, ELROY10, 10, elroy_fit_, 08-15",
    "trendcarpet, stylingbymanonb20, 20, stylingbymanonb, 08-15",
    "only, CHARLOTTE12, 12, charlottedb__, 08-15",
    "hellofresh.nl, HF110DEMI, €110, demivdn, 08-15",
    "shein, kristM, 15, krist__lifestyle, 08-15",
    "madebel.nl, Ronja15, 15, ronjazbx, 08-15",
    "lampenmaster.nl, keekshuis4, 4, keekshuis, 08-15",
    "organicbasics, OBXSTEPH, 10, letstalkslow, 08-15",
    "vertbaudet.nl, JUDITH30, 30, judith.keijsers, 08-15",
    "airalo, LAURA33, €3, lauraponticorvo, 08-15",
    "geurwolkje, ROMY, 10, romy.derooij, 08-15",
    "aybl, GATH10, 10, itsgath, 08-15",
    "nakdfashion, lisannekTKT, 20, lisannekoning_tiktok, 08-15",
    "burga, SAMSMXNL, 15, samsmitts, 08-15",
    "stronger, demi20, 20, deminugteren, 08-15",
    "emmasleepnl, NIKEE10, 10, nikeesacha, 08-15",
    "womensbest, Jacqueline, 10, hergardengym, 08-15",
    "finaste.nl, SHOP20, 20, finaste.nl, 08-15",
    "begolden, YARA20, 20, yaralambregtse_tiktok, 08-15",
    "goboony, KEMPER35, €35, geraldine_kemper, 08-15",
    "ullapopken.nl, margo716, 20, hetismarg, 08-15",
    "goedgemerkt, IG-MICHELLE10, 10, girlsmom_chellebell, 08-15",
    "loubana.nl, Anne10, 10, mijn.nieuw_jaar, 08-15",

    "shein, famke, 15, famkelouise_, 08-13",
    "asos (13 aug), SAVE, 20, asos, 08-13",
    "gutsgusto, TINASON15, 15, tinason__, 08-13",
    "ginatricot, SINI20, 20, rabatt.inspo, 08-13",
    "idealofsweden, BBDAL, 15, wgk, 08-13",
    "nakdfashion (not sale), meganveermantkt, 20, meganveerman_tiktok, 08-13",
    "bodyandfit.com, BFJANNE, 10, jannevbokhoven, 08-13",
    "terstal (13aug / new col), NIEUW15, 15, terstal, 08-13",
    "lookfantastic, ACTIES, 10, acties.nl, 08-13",
    "gymshark, MIM, 10, mimsdaily.life, 08-13",
    "photowall_sweden, LOTTE20, 20, liefslotte, 08-13",
    "nakdfashion (not sale), Annepedersen, 20, anneepedersen, 08-13",
    "nakdfashion (not sale), FLEURNIJ, 20, fleurnijkamp, 08-13",
    "lentethelabel.nl, Jackie15, 15, kusjesvanjackie_tiktok, 08-13",
    "miniorojewelry, ELLIS10, 10, ellistenheuvel, 08-13",
    "armonicci, kieran20, 20, _kieran_2, 08-13",
    "loopearplugs, LOOPXBRINDA10, 10, wavybrin, 08-13",
    "biteswelove (bij AH), AH6130, 50, biteswelove, 08-13",
    "mattisson.nl, deveganmoeder, 10, deveganmoeder, 08-13",
    "nakdfashion (not sale), TAMMOUNNA, 20, tammounna, 08-13",
    "ginatricot, GOOL20, 20, rabattkodersverige, 08-13",
    "esn, LOTTELEURS, 10, lotte.leurs, 08-13",
    "shein, lisannebts, 15, lisannekoning_tiktok, 08-13",
    "flaatch.nl, MADELIEF20, €20, spam.madelief_tiktok, 08-13",
    "myproteinnl, LARISSA, 37, larissavanmeerten, 08-13",
    "xxlnutrition (kleding), XXLWENDIE10, 10, wendievlaar, 08-13",
    "geurwolkje, CHARISSA, 10, charissa_real, 08-13",
    "shein, 24q3xcarolcmx, 15, xcarolcmx, 08-13",
    "aybl, SYNEAD10, 10, synead_gym, 08-13",
    "secretsales.nl, YAELLA, 10, budget.stuff.girl, 08-13",
    "smartphoto.nl, Francis20, 20, meisjes.in.huis, 08-13",
    "custtom.nl, MARIA25, 25, mariatailor, 08-13",
    "famousstore, noortje10, 10, noortje.derijk_tiktok, 08-13",
    "burga, KYRAJANSXNL, 15, kyrajanssenn, 08-13",
    "stronger, MAAIKE20, 20, maaikelothmann, 08-13",
    "begolden, PAREL20, 20, pareljansen_tiktok, 08-13",
    "tylko, LeonieSummer, 41, lterveld, 08-13",
    "paulie__pocket, MIRIAM-15, 15, seebymiriam, 08-13",
    "goedgemerkt, GG-SHAN15, 15, shandiracorielle_tiktok, 08-13",

    "nakdfashion, loisblog, 50+10, loisblog, 08-09",
    "shein, 24Q3LUCYLU, 15, lucyashton_xx, 08-09",
    "drsmile.nl, SASKIA300, €300, saskiaweerstand, 08-09",
    "desenio, XWHAT, 40+10, kleinpepertje, 08-09",
    "ginatricot, sophieberna20, 20, sophieberna, 08-09",
    "idealofsweden, BBGOUD, 50+15, wgk, 08-09",
    "arket, ARKET14, 14, honey, 08-09",
    "airup (steel bottle), JAN, 10, janedoe, 08-09",
    "esn, ALOHALIES, 10, aloha.lies, 08-09",
    "bodyandfit.com, BBSUUS, 10, fitbysuus, 08-09",
    "gutsgusto, AMELIE15, 15, amelie_weissenberger, 08-09",
    "mimamsterdam, XWILLEMIJN20XX, 20, willemijnvreee_tiktok, 08-09",
    "myproteinnl, JENGOESNUTS, 35, jengoesnuts, 08-09",
    "lookfantastic, FAST, 25, lookfantastic, 08-09",
    "gymshark, CHARLOTTET, 10, fitness_with_charl, 08-09",
    "veganboost.nl, TIKTOK15, 15, michelle.en.hicham_tiktok, 08-09",
    "famousstore, Bentep10, 10, itsmebenteee_tiktok, 08-09",
    "nakdfashion, kazen, 50+10, mariekekazen, 08-09",
    "nakdfashion, nataschalike, 50+10, nataschalike, 08-09",
    "leolive, IRENEsummer10, 10, irenefior_, 08-09",
    "shein, giusy24q3, 15, giusy_marasa_official, 08-09",
    "geurwolkje, life.ofnadine, 10, lifeof.nadine, 08-09",
    "aybl, MENA, 10, menafitness_, 08-09",
    "leolive, SELENAvacay, 10, selenadinexz, 08-09",
    "famousstore, YVON10, 10, yvonnn__tiktok, 08-09",
    "otrium (> €60), FASHION, 20, honey, 08-09",
    "burga, SOPHIEMX15, 15, sophiemilzink, 08-09",
    "stronger, curly20, 20, curly.iris, 08-09",
    "begolden, DANTHE20, 20, danthescholtenx, 08-09",
    "finaste.nl, ESMEE15, 15, esmeealissageel_tiktok, 08-09",
    "lightofthemoon.nl, Willemijn10, 10, willemijnvreee_tiktok, 08-09",
    "mayafreya.nl, Jamey20, 20, jamey.nl, 08-09",
    "qkoreaansecosmetica, ISABELLE20, 20, isabelle.dk, 08-09",
    "noboringsuitcases, sem35, 35, semdeconinck, 08-09",
    "rovey.nl, FAMKE15, 15, famkehanna_tiktok, 08-09",
    "novibelle.nl, Jenny10, 10, jennyvaassen_tiktok, 08-09",
    "lensmart, WAHIDA, 15, wahidanasira_tiktok, 08-09",
    "horse-event.nl, carmenxhe2024, 10, horsesbycarmen, 08-09",
    "juudth.nl, Mel10, 10, blissofmel, 08-09",
